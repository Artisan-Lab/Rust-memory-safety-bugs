...
| rust-std | GitHub | [issues/27970](https://github.com/rust-lang/rust/issues/27970) | FFIUB+CC | UAF | setenv is unsafe | bluss-Rust | No | 
| rust-std | GitHub | [issues/33770](https://github.com/rust-lang/rust/issues/33770) | FFIUB+CC | UAF | glibc recursive lock is UB->shared mut aliases | Amanieu | No | 
| rust-std | GitHub | [issues/35836](https://github.com/rust-lang/rust/issues/35836) | FFIUB+CC | UAF | recursive RWlock on Windows is UB | retep998-Rust | No | 
...
| rust-std | GitHub | [issues/39575](https://github.com/rust-lang/rust/issues/39575) | FNSIG(UNSAFE)+FFI+CC | UB | should be unsafe, UB according to POSIX (CommandExt::before_exec) | fweimer | No | 
...
| rust-std | GitHub | [issues/42789](https://github.com/rust-lang/rust/issues/42789) | TGENERIC+CASE | OOR | interators over ZST slices are undefined->random addr （Iter+ZST） | RalfJung-Rust | No | 
| rust-std | GitHub | [issues/43733](https://github.com/rust-lang/rust/issues/43733) | LOE+CC | UAF | access static value without unsafe marker->CC(thread::local) | eddyb-Rust | No | 
...
| rust-std | GitHub | [issues/45197](https://github.com/rust-lang/rust/issues/45197) | TYPE+CC | UAF | AUTOTRAIT:bypassing sync/send check（fmt::Arguments）+PhantomData | cuviper-Rust | No | 
| rust-std | GitHub | [issues/46775](https://github.com/rust-lang/rust/issues/46775) | FFIUB+CC | UAF | multi-thread unsafe (unix::process::CommandExt::exec) | Diggsey | No | 
...
| rust-std | GitHub | [issues/51780](https://github.com/rust-lang/rust/issues/51780) | EAPI(MEM)+CC | DR->UAF | insufficient synchronization (Arc::is_unique) Relaxed->Acquire | jhjourdan | No | 
| rust-std | GitHub | [issues/54857](https://github.com/rust-lang/rust/issues/54857) | TGENERIC+CASE | OOR | UB in computing the offset addr for ZST or 0-len Vec（Vec） | jturner314 | No | 
| rust-std | GitHub | [issues/54908](https://github.com/rust-lang/rust/issues/54908) | TGENERIC+CASE | OOR | misaligned reference（RC，ARC） | RalfJung | No | 
...
| rust-std | GitHub | [issues/57534](https://github.com/rust-lang/rust/issues/57534) | FFIUB+CC | UAF | TLS:_tlv_atexit during tlv_finalize is UB (thread_local) | mtak- | May | 
...
| rust-std | GitHub | [issues/66544](https://github.com/rust-lang/rust/issues/66544) | TGENERIC | UB->UAF | soundness holes of when impl DerefMut/Clone (Pin) | comex |
| rust-std | GitHub | [issues/67194](https://github.com/rust-lang/rust/issues/67194) | TGENERIC | UB->OOR | violate the always applicable test (PartialEq for RangeInclusive) | comex | No | 
...
| rusqlite | **CVE-2020-35871** | [Auxdata API](https://github.com/rusqlite/rusqlite/commit/2ef3628dac35aeba0a97d5fb3a57746b4e1d62b3) | TBOUND+CC | DR->UAF | lack sync/send bound | thomcc-deps| No | 
| rusqlite | **CVE-2020-35870** | [Auxdata API](https://github.com/rusqlite/rusqlite/commit/2ef3628dac35aeba0a97d5fb3a57746b4e1d62b3) | TBOUND+CC | DR->UAF | lack sync/send bound | thomcc-deps | No | 
| rusqlite | **CVE-2020-35869** | [log](https://github.com/rusqlite/rusqlite/commit/2327d3b774927fdf48903c0bdc1ca7ec93c7c8d0) | EAPI+FFI | OOR | wrong parameters in api call | thomcc-deps| No | 
| rusqlite | **CVE-2020-35868** | [UnlockNotification](https://github.com/rusqlite/rusqlite/commit/45fd77ee43c38eea4d6f4e2e56c1667a55ec654f) | RAII+CC | UB | NLL:mutex lock is released before send condvar | No (gwenn-deps) | No | 
...
| bumpalo | **CVE-2020-35861** | [issues/69](https://github.com/fitzgen/bumpalo/issues/69) | LOE(Simple) | OOR(Read) | copy wrong size | No (Riey-deps)| No | 
...
| actix-net | **CVE-2020-35899** | [pull/158](https://github.com/actix/actix-net/pull/158) | EAPI+CC | DR->UAF | replace Cell<T> with Rc<RefCell<T>> | Shnatsel | No | | No |
| actix-net | **CVE-2020-35898** | [issues/160](https://github.com/actix/actix-net/issues/160) | EAPI+CC | DR->UAF | replace Cell<T> with Rc<RefCell<T>>  | Shnatsel | No | | No |
| actix-web | Advisory-DB | [issues/289](https://github.com/actix/actix-web/issues/289) | LOE | UAF | multiple issues | seanmonstar | No | No | - |
| actix-web | Advisory-DB | [issues/301](https://github.com/actix/actix-web/issues/301) | TBOUND+CC | UAF | InternalError with generics is unsound for Rc | seanmonstar-Mozilla | No | 
| actix-web | **CVE-2020-35901** | [issues/1321](https://github.com/actix/actix-web/issues/1321) | TBOUND+CC | DR->UAF | BodyStream should be pined | sebzim4500 | No | | No |
...
| atom | **CVE-2020-35897** | [issues/13](https://github.com/slide-rs/atom/issues/13) | TBOUND+CC | DR->UAF | lack send/sync bound | ammaraskar-Sec | No | | No | 
...
| futures-intrusive | **CVE-2020-35915** | [issues/53](https://github.com/Matthias247/futures-intrusive/issues/53) | TBOUND+CC | DR->UAF | lack send/sync bound | ammaraskar-Sec| No | No | No |
...
| futures-rs| **CVE-2020-35905** | [issues/2239](https://github.com/rust-lang/futures-rs/issues/2239) | TBOUND+CC | CC->UAF | lack send/sync bound | Qwaz-Sec | No | No | No |
...
| pulse-binding-rust | Advisory-DB | [Iterator](https://github.com/jnqnfe/pulse-binding-rust/commit/9e31c82d71749619387cb9d0c9698134d05b28c9) | TYPE | UAF | lack lifetime bound: +PhantomData | jnqnfe | No | | May |
...
| parking_lot | **CVE-2020-35910** | [MappedMutexGuard](https://github.com/Amanieu/parking_lot/issues/258) | TBOUND+CC | DR->UAF | lack send bound | ammaraskar-Sec | No | No | No |
| parking_lot | **CVE-2020-35911** | [MappedRwLockReadGuard](https://github.com/Amanieu/parking_lot/issues/258) | TBOUND+CC | DR->UAF |  lack sync bound | ammaraskar-Sec | No | No | No |
| parking_lot | **CVE-2020-35912** | [MappedRwLockWriteGuard](https://github.com/Amanieu/parking_lot/issues/258) | TBOUND+CC | DR->UAF |  lack send bound | ammaraskar-Sec | No | No | No |  
| parking_lot | **CVE-2020-35913** | [RwLockReadGuard](https://github.com/Amanieu/parking_lot/issues/259) | TBOUND+CC | DR->UAF | lack sync bound | ammaraskar-Sec | No | No | No | 
| parking_lot | **CVE-2020-35914** | [RwLockWriteGuard](https://github.com/Amanieu/parking_lot/issues/259) | TBOUND+CC | DR->UAF | lack sync bound | ammaraskar-Sec | No |  No | No |
| magnetic | **CVE-2020-35925** | [issues/9](https://github.com/johnshaw/magnetic/issues/9) | TBOUND+CC | DR->UAF | lack send/sync bound | JOE1994-Sec | No | No | No |
...
| thex | **CVE-2020-35927** | - | TBOUND+CC | DR->UAF | lack send/sync bound | Qwaz-Sec | No |  | No |
| time | **CVE-2020-26235** | [issues/293](https://github.com/time-rs/time/issues/293) | FFIUB+CC | UB->UAF | call non-atomic libc functions (setenv) | quininer | <-> |  | No |
| try-mutex | **CVE-2020-35924** | [issues/2](https://github.com/mpdn/try-mutex/issues/2) | TBOUND+CC | DR->UAF | lack send/sync bound | ammaraskar-Sec | No |  | No |
...
| rio | **CVE-2020-35876** | [issues/11](https://github.com/spacejam/rio/issues/30) | FNSIG(SAFE) | UAF | logical error: soundness hole | No (dtolnay-Rust) | No | | No |
| bitvec | **CVE-2020-35862** | [issues/55](https://github.com/myrrlyn/bitvec/issues/55) | LOE+SYS | UAF | MacOS reallocate the address after shrinking; Should use the new addr. | kulp-sec | No | No | | No |
| cbox-rs | **CVE-2020-35860** | [issues/2](https://github.com/TomBebbington/cbox-rs/issues/2) | FNSIG(SAFE) | UAF | declare unsafe API as safe | No (eduardosm) | No | | No |
...
| crossbeam | **CVE-2020-35904** | [pull/533](https://github.com/crossbeam-rs/crossbeam/pull/533) | EAPI | UB->UAF | drop memory not owned Vec->Box | caelunshun | No | 
...
| generator-rs | Advisory-DB | [issues/9](https://github.com/Xudong-Huang/generator-rs/issues/9) | FNSIG(SAFE) | UB | func. sign.->deref invalid/null pointer | jonas-schievink | No | No | - |
...
| array | **CVE-2020-35886** | [issues/1:Array](https://github.com/sjep/array/issues/1) | TBOUND+CC | DR->UAF | lack sync/send bound | Qwaz-Sec | No | | No |
...
| obstack | **CVE-2020-35894** | [issues/4](https://github.com/petertodd/rust-obstack/issues/4) | GENERIC+CASE | UB | generates unaligned references for types with a large alignment | Qwaz | No | No | - |
...
| Rocket | **CVE-2020-35882** | [issues/1312](https://github.com/SergioBenitez/Rocket/issues/1312) | TYPE | UB->UAF | Clone may incur mutable aliases | Qwaz | No |
| teaclave-sgx-sdk  | **CVE-2020-5499** | www.mitre.org | LOE+CC | UB | may init twice by another thread/+Once::new() | Chen-sec | No | No | - |
...
| rust-rgb | **CVE-2020-25016** | [issues/35](https://github.com/kornelski/rust-rgb/issues/35) | FNSIG(SAFE) | UB | declare unsafe API as safe | HeroicKatora | No | No | - |
| renderdoc-rs | **CVE-2019-16142** | [issues/27](https://github.com/ebkalderon/renderdoc-rs/issues/27) | FNSIG(MUT) | UB | mutable (internal mutation) | ebkalderon-owner | No | No | - | 
| rulinalg | **CVE-2020-35879** | [issues/201](https://github.com/AtheMathmo/rulinalg/issues/201) | FNSIG(LIFE) | UB->UAF | func. sign.:lifetime | Qwaz-sec | No | | No |
| flatbuffers | **CVE-2020-35864** | [issues/5825](https://github.com/google/flatbuffers/issues/5825) | FNSIG(SAFE) | UB | func. sign.: safety declaration | eduardosm | No | No | - |
...
| curl-rust | GitHub | [issues/333](https://github.com/alexcrichton/curl-rust/issues/333) | FFIUB+CC | UB | does not enforce FFI restrictions | DemiMarie/sagebind-deps | Yes | No | - |
...
| diem-libra (exe) | GitHub | [pull/1949](https://github.com/diem/diem/pull/1949) | FNSIG(LIFE) | UAF | ineffective lifetime restriction (too_owned()) | dtolnay-Rust | No | No | May |
...
| servo (exe) | GitHub | [issues/14014](https://github.com/servo/servo/issues/14014) | LOE+CC | UAF | clone FlowRef lead to share aliases => Arc<Flow>  | pcwalton-deps | No | 
| servo (exe) | GitHub | [issues/14416](https://github.com/servo/servo/issues/14416) | LOE | UAF | FnBox<()>  | pcwalton-deps | No | No | No |
| servo (exe) | GitHub | [issues/20158](https://github.com/servo/servo/issues/20158) | FNSIG(SAFE) | UB | declare unsafe constructor as safe  | nox-org | No | 
| servo (exe) | GitHub | [issues/21186](https://github.com/servo/servo/issues/21186) | EAPI+CC | UB | Relaxed->Acquire, same as rust-std-51780 | RalfJung | No | No | No | 
