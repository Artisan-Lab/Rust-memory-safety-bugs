...
| miow | **CVE-2020-35921** | [issues/38](https://github.com/yoshuawuyts/miow/issues/38) | FFIUB | ERR | assumes the same layout of FFI | faern | No | No | No | 
...
| string-interner | **CVE-2019-16882** | [issues/9](https://github.com/Robbepop/string-interner/issues/9) | RAII | ERR | UAF | CLONE:bad derived clone | No (lo48576-deps) | No |  | No |
