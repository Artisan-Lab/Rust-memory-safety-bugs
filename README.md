...
| actix-web | Advisory-DB | [issues/301](https://github.com/actix/actix-web/issues/301) | TBOUND+CC | UNSOUND | UAF | InternalError with generics is unsound for Rc | seanmonstar-Mozilla | No | 
