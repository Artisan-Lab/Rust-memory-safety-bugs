...
| ncurses | CVE-2019-15547 | issues/172 | RU:SAFE:FFI (API) | OOR:BO | FFI-unchecked argument/printw() | thomcc | No | 
| ncurses | CVE-2019-15548 | issues/186 | RU:SAFE:FFI (API) | OOR:BO | FFI-unchecked argument/instr(), mvwinstr() | thomcc |
...
| rust-base64 | CVE-2017-1000430 | issues/28 | GEN (Imp) | OOR:BO | arithmatic overflow + unsafe write | No (alicemaz) | No | 
| failure | CVE-2020-25575 | issues/336 | RU:SAFE (API) | OOR:BO | downcast$\to$mem misalign/private_get_type_id() | No (Qwaz-sec) | No | 
...
| safe-transmute | CVE-2018-21000 | pull/36 | GEN (Imp) | OOR:BO | logical error + unsafe write | No (Enet4-deps)| No | 
| slice-deque | CVE-2018-20995 | pull/58 | GEN (Imp) | OOR:BO | error in boundary check + unsafe write | No (aldanor-deps) | No | 
| slice-deque | CVE-2019-15543 | pull/66 | GEN (Imp) | OOR:BO | logical error$\to$memory misalignment | No (zimond) | No | 
| rust-smallvec | CVE-2019-15554 | issues/149 | IMP:GEN (Imp) | OOR:BO | logical error + unsafe write | No (ehuss) | No | 
| rust-smallvec | Advisory-DB | issues/126 | RAII:UNWIND (Imp) | DP:DUN | init vector with mem:uninitialized() | No (mbrubeck) | No | 
| rust-smallvec | CVE-2019-15551 | issues/148 | GEN (Imp) | DP:UAF | logical error + unsafe deallocation | No (ehuss) | No | 
| rust-smallvec | CVE-2018-20991 | issues/96 | RAII:UNWIND (Imp) | DP:DF | buffer shrinking too late | No (Vurich) | No | 
| simd-json | CVE-2019-15550 | pull/27 | GEN (Imp) | OOR:BO | logical error$\to$mem misalign/get_unchecked() | No (Licenser-deps) | No | 
| v_espace | Trophy Case | issues/47 | IMP:GEN (Imp) | OOR:BO | logical error$\to$mem misalign | \_mm_load_si128() | No (tmiasko) | No | 
| sized-chunks | CVE-2020-25791 | issues/11:unit | GEN (API) | OOR:BO | lack input consistency check + unsafe write | No (Qwaz-sec) | No | 
| sized-chunks | CVE-2020-25792 | issues/11:pair | GEN (API) | OOR:BO | lack input consistency check + unsafe write | No (Qwaz-sec) | No | 
| sized-chunks | CVE-2020-25793 | issues/11:From | GEN (API) | OOR:BO | lack input consistency check + unsafe write | No (Qwaz-sec) | No | 
| sized-chunks | CVE-2020-25796 | issues/11:InlineArray | GEN (API) | OOR:BO | no input check$\to$memory misalignment | No (Qwaz-sec) | No | 
| sized-chunks | CVE-2020-25794 | issues/11:clone | RAII:UNWIND (Imp) | DP:DUN | panic $\to$ drop uninitialized memory | No (Qwaz-sec)  | No | 
| sized-chunks | CVE-2020-25795 | issues/11:insert_from | RAII:UNWIND (Imp) | DP:DUN | panic $\to$ rop uninitialized memory | No (Qwaz-sec)  | No | 
...
| isahc | CVE-2019-16140 | issues/2 | RAII (Imp) | DP:UAF | unsafe constructor+no ManuallyDrop | No (nox) | No | 
| sxd-document  | Trophy Case | issues/47 | RAII (Imp) | DP:UAF | unsafe constructor+no ManuallyDrop | No (CryZe-sec) | No | 
| image | CVE-2019-16138 | issues/980 | RAII:UNWIND* (Imp) | DP:DUN | unsafe allocation$\to$drop uninit mem/set_len() | No (64) | No | 
| image | CVE-2020-35916 | issues/1357 | IMP:MUT | UB | convert mutable ptr from const ptr | dodomorandi | No | 
| libflate | CVE-2019-15552 | issues/35 | RAII:UNWIND (Imp) | DP:DUN  | enf. ManuallyDrop late$\to$drop uninit | No (Shnatsel-sec) | No | 
| memoffset | CVE-2019-15553 | issues/9 | RAII:UNWIND (Imp) | DP:DUN | enf. ManuallyDrop late$\to$drop uninit mem  | No (Centril) | No | 
| linked-hash-map | CVE-2020-25573 | pull/100 | RAII (Imp) | DP:DUN | object with uninit mem of type T (HashMap) | No (SpaceManiac-deps)| No | 
...
| rust-openssl | CVE-2018-20997 | issues/941 | RAII (Imp) | DP:UAF | pointer obj lifetime inconsistency/as_ptr() | No (fred-gremlin)| No | 
| string-interner | CVE-2019-16882 | issues/9 | IMP:RU:DERIVE (Imp) | DP:UAF | bad derived clone | No (lo48576-deps) | No |  
| crossbeam | CVE-2018-20996 | issues/82 | IMP:RAII* (Imp) | DP:DF | shared mut aliases+auto drop/+ManuallyDrop | No (c0gent-deps) | No | 
| crossbeam | Advisory-DB | pull/533 | IMP:LOE | UB$\to$UAF | drop memory not owned | caelunshun | No | 
| generator-rs | CVE-2019-16144 | issues/11 | IMP:RAII* (Imp) | DP:DF | shared mut aliases+auto drop | No (vOROn200) | No | 
...
| portaudio-rs | CVE-2019-16881 | issues/20 | RU:DROP (Imp) | DP:DF | enf. ManuallyDrop late$\to$drop twice | No (Phosphorus15) | No | 
| http | CVE-2020-25574 | issues/354 | RAII (Imp) | DP:DF | buf. shrinking too late (rely on drop) | No (Qwaz-sec) | No | 
...
| spin-rs  | CVE-2019-16137 | issues/65 | IMP:GEN (Imp) | CC:DR | impl error: Ordering::Relaxed$\to$Release | No (64) | No | 
| vm-memory | CVE-2020-13759 | issues/93 | IMP:GEN (Imp) | CC:RC | volatile mem acc/ptr::write()$\to$write_volatile() | No (andreeaflorescu-deps)| No | 
| teaclave-sgx-sdk  | 2020-5499 | www.mitre.org | GEN (API) | CC:DR | may init twice by another thread/+Once::new() | No (Chen-sec) | No | 
| claxon  | CVE-2018-20992/Trophy | issues/10 | IMP:GEN (Imp) | DL | unsafe buf alloc$\to$read unit mem/Vec::set_len() | No (Shnatsel-sec)| No | 
| rust-rgb | CVE-2020-25016 | issues/35 | RU:Safe (API) | Unsound | declare unsafe API as safe | No (HeroicKatora) | No | 
| renderdoc-rs | CVE-2019-16142 | issues/27 | RU:MUT (API) | Unsound | func. sign.$\to$unsync. internal mutation | No (ebkalderon-owner) | No | 
...
| once_cell | CVE-2019-16141 | issues/46 | GEN* (Imp) | Unsound | unreachable_unchecked()$\to$panic!() | No (xfix-deps) | No | 
...
| rand | CVE-2020-25576 | issues/779 | GEN* (Imp) | Unsound | reading unaligned mem/ptr::read_unaligned() | No (RalfJung-sec)| No | 
