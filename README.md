...
| rust-std | GitHub | [issues/42789](https://github.com/rust-lang/rust/issues/42789) | GENERICS+CASE | ERR | OOR | interators over ZST slices are undefined->random addr （Iter+ZST） | RalfJung-Rust | No | 
...
| rust-std | GitHub | [issues/45197](https://github.com/rust-lang/rust/issues/45197) | AUTOTRAIT+CC | UNSOUND | UAF | bypassing sync/send check（fmt::Arguments）+PhantomData | cuviper-Rust | No | 
| rust-std | GitHub | [issues/46775](https://github.com/rust-lang/rust/issues/46775) | UBFFI+CC | MID | UAF | multi-thread unsafe (unix::process::CommandExt::exec) | Diggsey | No | 
...
| rust-std | GitHub | [issues/54857](https://github.com/rust-lang/rust/issues/54857) | GENERICS+CASE | ERR | OOR | UB in computing the offset addr for ZST or 0-len Vec（Vec） | jturner314 | No | 
| rust-std | GitHub | [issues/54908](https://github.com/rust-lang/rust/issues/54908) | GENERICS+CASE | ERR | OOR | misaligned reference（RC，ARC） | RalfJung | No | 
...
| rust-smallvec | **CVE-2018-20991** | [issues/96](https://github.com/servo/rust-smallvec/issues/96) | UNWIND+RAII | ERR | DF | buffer shrinking too late | No (Vurich) | No | | Hard |
...
| actix-net | **CVE-2020-35898** | [issues/160](https://github.com/actix/actix-net/issues/160) | EAPI+DR | ERR | DR->UAF | replace Cell<T> with Rc<RefCell<T>>  | Shnatsel | No | | No |
...
| actix-web | **CVE-2020-35901** | [issues/1321](https://github.com/actix/actix-web/issues/1321) | TBOUND+PIN | TBOUND+PIN | DR->UAF | BodyStream should be pined | sebzim4500 | No | | No |
...
| arc-swap | **CVE-2020-35711** | [issues/45](https://github.com/vorner/arc-swap/issues/45) | PHANTOM+STRUCT | ERR | UAF | logical errors +PhantomData | Qwaz-Sec | No | | MAY |
...
| Rocket | **CVE-2020-35882** | [issues/1312](https://github.com/SergioBenitez/Rocket/issues/1312) | TRAIT+LOE | ERR | UB->UAF | Clone may incur mutable aliases | Qwaz | No |
...
| rulinalg | **CVE-2020-35879** | [issues/201](https://github.com/AtheMathmo/rulinalg/issues/201) | FNSIG(LIFE) | UNSOUND | UB->UAF | func. sign.:lifetime | No (Qwaz-sec)  | No | | No |
